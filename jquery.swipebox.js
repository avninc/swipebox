	...
	$.swipebox = function( elem, options ) {
		...
		var ui,
			defaults = {
				...
				queryStringData: {},
				toggleClassOnLoad: '',
				touchEventElement: '#swipebox-slider'
			},
		...
		ui = {
			...
			gesture : function () {
				...
				$( plugin.settings.touchEventElement ).bind( 'touchstart', function( event ) {
			...
			destroy : function () {
				$( window ).unbind( 'keyup' );
				$( plugin.settings.touchEventElement ).unbind( 'touchstart' );
				$( plugin.settings.touchEventElement ).unbind( 'touchmove' );
				$( plugin.settings.touchEventElement ).unbind( 'touchend' );
